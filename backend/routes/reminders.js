...
<body style="margin:0;padding:0;background:#F7F7FB;font-family:DM Sans,ui-sans-serif,system-ui">
  <div style="max-width:560px;margin:32px auto;background:white;border-radius:20px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06)">
    ...
    <div style="background:#534AB7;padding:28px 32px">
      ...
      <p style="color:rgba(255,255,255,0.8);font-size:14px;margin:6px 0 0">Your daily study reminder is here. Keep your streak going!</p>
    </div>

    <!-- Body -->
    <div style="padding:28px 32px">
      <p style="font-size:14px;color:#4b5563;margin:0 0 20px">You have <strong>${notes.length} topic${notes.length !== 1 ? 's' : ''}</strong> ready for review. Consistent revision is the key to remembering what you learn.</p>
        ...
        <table style="width:100%;border-collapse:collapse">
          <thead>
            <tr style="background:#f9f9ff">
              <th style="padding:10px 12px;text-align:left;font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:0.05em">Topic</th>
              <th style="padding:10px 12px;text-align:left;font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:0.05em">Subject</th>
              <th style="padding:10px 12px;text-align:left;font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:0.05em">Quiz</th>
              <th style="padding:10px 12px;text-align:left;font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:0.05em">Cards</th>
            </tr>
          </thead>
      ...
      <div style="text-align:center;margin-bottom:24px">
        <a href="http://localhost:3000" style="display:inline-block;background:#534AB7;color:white;text-decoration:none;padding:12px 28px;border-radius:10px;font-size:14px;font-weight:600">
          Start Studying Now →
        </a>
      </div>
    ...
    <div style="padding:16px 32px;background:#f9f9ff;border-top:1px solid #f0f0f0">
      <p style="font-size:12px;color:#9ca3af;margin:0;text-align:center">
        Study Buddy · AI Learning Assistant<br>
        <a href="http://localhost:3000" style="color:#534AB7;text-decoration:none">Open app</a> · You received this because you enabled study reminders.
      </p>
    </div>
  </div>
</body>
